...
function configSigmaElements(config) {
    ...
    var a = [], party = ["Dansk Folkeparti", "Social Demokratiet","Venstre", "Jesper","Jesper","Jesper","Jesper","Jesper","Jesper","Jesper","Jesper","Jesper","Jesper","Jesper","Jesper","Jesper"]
        b,x=0;
		for (b in sigInst.clusters) a.push('<div style="line-height:12px"><a href="#' + b + '"><div style="width:40px;height:12px;border:1px solid #fff;background:' + b + ';display:inline-block"></div> Group ' + party[0] + ' (' + sigInst.clusters[b].length + ' members)</a></div>');
    //a.sort();
